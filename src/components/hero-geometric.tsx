...
function HeroGeometric({
  badge = "MOMU SCAN",
  title1 = "สแกนอาหาร",
  title2 = "ติดตามสุขภาพด้วย AI",
  description = "วิเคราะห์แคลอรี่จากรูปถ่ายอาหารอัตโนมัติ ติดตามโภชนาการ และดูแลสุขภาพอย่างชาญฉลาด",
}: {
  badge?: string;
  title1?: string;
  title2?: string;
  ...
  return (
    <div className="relative min-h-[45vh] w-full flex items-center justify-center overflow-hidden bg-[#030303] rounded-b-3xl">
